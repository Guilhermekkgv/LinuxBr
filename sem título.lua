...
local COLORS = {
    PRIMARY = Color3.fromRGB(45, 110, 220),
    SECONDARY = Color3.fromRGB(120, 80, 220),
    SUCCESS = Color3.fromRGB(30, 180, 85),
    WARNING = Color3.fromRGB(220, 170, 10),
    ERROR = Color3.fromRGB(220, 60, 60),
    BACKGROUND = Color3.fromRGB(30, 40, 55),
    BACKGROUND_LIGHT = Color3.fromRGB(40, 50, 65),
    TEXT_PRIMARY = Color3.fromRGB(255, 255, 255),
    TEXT_SECONDARY = Color3.fromRGB(200, 210, 220),
}
...
function RoUI.CreateWindow(title, size, tabWidth)
    ...
    local TabFill = Create("Frame", {
        Name = "TabFill",
        Position = UDim2.new(1, -CORNER_RADIUS.Offset, 0, 0),
        Size = UDim2.new(0, CORNER_RADIUS.Offset, 1, 0),
        BackgroundColor3 = COLORS.BACKGROUND_LIGHT,
        BorderSizePixel = 0,
        Parent = TabContainer
    })
    ...
    function Window:SelectTab(tabName)
        ...
        if self.ActiveTab then
            ...
            Tween(oldTab.Button.Text, {TextColor3 = COLORS.TEXT_SECONDARY})
            oldTab.Content.Visible = false
        end
        
        local newTab = self.Tabs[tabName]
        Tween(newTab.Button, {BackgroundTransparency = 0})
        Tween(newTab.Button.Text, {TextColor3 = COLORS.TEXT_PRIMARY})
